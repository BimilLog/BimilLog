                ...
                headers: [
                    {
                        ...
                        value: [
                            ...
                            "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.jsdelivr.net https://*.kakao.com https://*.kakao.sdk.io https://t1.kakaocdn.net https://t1.daumcdn.net https://*.daumcdn.net https://postfiles.pstatic.net https://dapi.kakao.com https://www.gstatic.com https://www.gstatic.com/firebasejs/ https://www.googletagmanager.com",
                            // 스타일시트 허용
                            ...
                            "connect-src 'self' https: http: https://grow-farm.com ws://grow-farm.com https://*.kakao.com https://dapi.kakao.com https://analytics.ad.daum.net https://kaat.daum.net https://kuid-provider.ds.kakao.com https://*.daumcdn.net https://www.google-analytics.com https://analytics.google.com",
