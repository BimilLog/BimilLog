            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  관한 법률 등 정보통신서비스 제공자가 준수하여야 할 관련
                  법규상의 개인정보보호 규정 및 지침을 준수하고 있습니다.
                  회사는 개인정보 처리방침을 통하여 이용자들이 제공하는
                  개인정보가 어떠한 용도와 방식으로 이용되고 있으며 개인정보
                  보호를 위해 어떠한 조치가 취해지고 있는지 알려 드립니다.
                  회사는 개인정보 처리방침을 홈페이지 첫 화면에 공개함으로써
                  이용자들이 언제나 용이하게 보실수 있도록 조치하고 있습니다.
                  회사의 개인정보 처리방침은 정부의 법률 및 지침 변경이나
                  회사의 내부 방침 변경 등으로 인하여 수시로 변경될 수
                  있으므로 이용자들께서는 사이트 첫페이지에 고지되는
                  개인정보처리방침을 사이트 방문 시 수시로 확인하시기
                  바랍니다. 회사의 개인정보 처리방침은 다음과 같은 내용을 담고
                  있습니다.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  &quot;개인정보&quot;라 함은 생존하는 개인에 관한 정보로서
                  당해 정보에 포함되어 있는 카카오톡 닉네임, 카카오톡
                  프로필사진 등의 사항에 의하여 당해 개인을 식별할 수 있는
                  정보(당해 정보만으로는 특정 개인을 식별할 수 없더라도 다른
                  정보와 용이하게 결합하여 식별할 수 있는 것을 포함)를
                  말합니다.
                </p>
                <p className="text-gray-700 leading-relaxed mb-4">
                  개인회원에 대하여 수집하는 개인정보 항목과 수집 및
                  이용목적은 다음과 같습니다.
                </p>
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  가입하실 때 서비스 제공을 위한 필수적인 정보들을
                  온라인상에서 입력 받고 있습니다. 회원 가입 시에 받는
                  필수적인 정보는 카카오ID(식별자), 카카오톡 닉네임, 카카오톡
                  프로필사진 등입니다. 또한 양질의 서비스 제공을 위하여
                  이용자들이 선택적으로 입력할 수 있는 사항으로서 전화번호
                  등을 입력 받고 있습니다. 또한 쇼핑몰 내에서의 설문조사나
                  이벤트 행사 시 통계분석이나 경품제공 등을 위해 선별적으로
                  개인정보 입력을 요청할 수 있습니다.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  ...
                  않으며 부득이하게 수집해야 할 경우 이용자들의 사전동의를
                  반드시 구할 것입니다. 그리고, 어떤 경우에라도 입력하신
                  정보를 이용자들에게 사전에 밝힌 목적 이외에 다른 목적으로는
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ① 파기절차 - 이용자가 회원가입 등을 위해 입력한 정보는
                  목적이 달성된 후 내부 방침 및 기타 관련 법령에 의한 정보보호
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ① 회사는 이용자들의 개인정보를 &quot;수집하는 개인정보 항목
                  및 수집∙이용목적&quot;에서 고지한 범위 내에서 사용하며,
                  이용자의 사전 동의 없이는 동 범위를 초과하여 이용하거나
                ...
                <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
                  ...
                  <li>
                    기타 법에 의해 요구된다고 선의로 판단되는 경우 (ex.
                    관련법에 의거 적법한 절차에 의한 정부/수사기관의 요청이
                    있는 경우 등)
                  </li>
                  <li>이용자들이 사전에 공개에 동의한 경우</li>
                  <li>
                    홈페이지에 게시한 서비스 이용 약관 및 기타 회원 서비스
                    등의 이용약관 또는 운영원칙을 위반한 경우
                  </li>
                  <li>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  개별적으로 고지하여 동의를 구하는 절차를 거치게 되며,
                  이용자가 동의하지 않은 경우에는 제휴사 등에게 제공하거나
                  공유하지 않습니다. 또한 이용자가 일단 개인정보의 제공에
              ...
              <section className="mb-8">
                <h2 className="text-xl font-semibold text-gray-800 mb-4 border-b border-gray-200 pb-2">
                  [8. 이용자 자신의 개인정보 관리(열람,정정,삭제 등)에 관한 사항]
                </h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  ① 이용자는 언제든지 비밀로그
                  홈페이지(https://grow-farm.com)에 로그인하셔서
                  회원정보변경에서 이용자의 개인정보를 열람하시거나 정정하실
                  수 있으며 회사 홈페이지(https://grow-farm.com)의
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  접속정보파일)&apos;를 운용합니다. 회사는 쿠키 운용과
                  관련하여 이용자의 컴퓨터는 식별하지만 이용자를 개인적으로
                  식별하지는 않습니다.
                </p>
                <p className="text-gray-700 leading-relaxed">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  귀하와의 원활환 의사소통을 위해 고객센터를 운영하고
                  있습니다.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  ② 개인정보와 관련하여 의견 또는 불만이 있는 경우,
                  개인정보보호책임자에게 해당 내용을 알려주시면 회사는 최선을
                  다하여 이용자들의 의견을 수렴하고 또한 불만에 대해서는
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ① 회사는 만14세 미만 아동(이하 &apos;아동&apos;이라
                  합니다)의 개인정보를 수집하는 경우 법정대리인의 동의를
                  받습니다.
                </p>
                <p className="text-gray-700 leading-relaxed mb-4">
                  ② 전항의 동의를 받기 위하여 동의서, 회사는 법정대리인의
                  성명, 연락처, 증빙자료 등 필요한 최소한의 정보를 요구할 수
                  있으며 이와 같이 수집된 법정대리인의 개인정보는 해당
                  법정대리인의 동의 여부를 확인하는 목적 외의 용도로
                  이용되거나 제3자에게 제공하지 아니합니다.
                </p>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  만료된 법정대리인 동의서는 계약, 청약철회, 대금결제, 재화
                  공급 등이 있는 경우 5년동안 보관됩니다.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  ⑤ 아동의 법정대리인은 당해 아동 개인정보의 열람, 정정요구,
                  또는 개인정보의 수집 이용 또는 제공에 대한 동의의 철회를
                  요청할 수 있으며, 이러한 요청이 있을 경우 회사는 필요한
                  조치를 취하겠습니다.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ① 이용자의 개인정보를 최신의 상태로 정확하게 입력하여 불의의 사고를 예방해주시기 바랍니다. 이용자가 입력한 부정확한 정보로 인해 발생하는 사고의 책임은 이용자 자신에게 있으며 타인 정보의 도용 등 허위정보를 입력할 경우 계정의 이용이 제한될 수 있습니다.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  ② 이용자는 개인정보를 보호받을 권리를 보유하나 이와 동시에 본인의 정보를 스스로 보호하고 또한 타인의 정보를 침해하지 않을 의무도 가지고 있습니다. 비밀번호를 포함한 이용자의 개인정보가 유출되지 않도록 조심하시고 게시물을 포함한 타인의 개인정보를 훼손하지 않도록 유의해 주십시오. 만약 이와 같은 책임을 다하지 못하고 타인의 정보 및 존엄성을 훼손할 시에는 『정보통신망 이용촉진 및 정보보호 등에 관한 법률』등에 의해 처벌받을 수 있습니다.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  개인정보보호책임자 및 담당자에게 해당 내용을 알려주시면
                  회사는 최선을 다하여 이용자들의 의견을 수렴하고 또한 불만에
                  대해서는 충분한 답변을 해 드리고 문제를 해결할 수 있도록
                  노력 하겠습니다.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  사항들에 반하는 사고가 발생할 경우 개인정보보호책임자가
                  책임을 집니다.
                </p>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  사고로 인한 정보의 훼손 및 방문자가 작성한 게시물에 의한
                  각종 분쟁에 관해서는 책임이 없습니다.
                </p>
                <p className="text-gray-700 leading-relaxed mb-4">
                  ④ 회사는 개인정보에 대한 의견수렴 및 불만처리를 담당하는
                  개인정보 보호책임자 및 담당자를 지정하고 있고, 연락처는
                  아래와 같습니다.
                </p>
