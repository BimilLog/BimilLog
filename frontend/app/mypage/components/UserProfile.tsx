                    ...
                    <div className="flex flex-col md:flex-row items-center md:space-x-8">
                        ...
                        <div className="relative mb-4 md:mb-0">
                            <Avatar className="w-24 h-24 md:w-32 md:h-32 ring-4 ring-white shadow-lg">
                                ...
                                />
                                <AvatarFallback
                                    className="text-4xl bg-gradient-to-r from-pink-500 to-purple-600 text-white">
                            ...
                            {user.role === "ADMIN" && (
                                <div
                                    className="absolute -top-1 -right-1 w-8 h-8 bg-gradient-to-r from-red-500 to-pink-600 rounded-full flex items-center justify-center">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            <div className="flex flex-col md:flex-row md:items-center md:space-x-4 mb-4">
                                <div
                                    className="flex items-center justify-center md:justify-start space-x-2 mb-2 md:mb-0">
                                ...
                                <div className="space-y-3">
                                    {user.kakaoNickname && (
                                        <div
                                            ...
                                            <span className="text-sm">카카오: {user.kakaoNickname}</span>
                                        </div>
                                    )}
