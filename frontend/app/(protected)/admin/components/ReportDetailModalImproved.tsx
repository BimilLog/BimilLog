...
export const ReportDetailModalImproved: React.FC<ReportDetailModalProps> = ({
  report,
  isOpen,
  onOpenChange,
  onReportUpdated,
  ...
  const { isProcessing, banUser, forceWithdrawUser } = useReportActions(() => {
    onOpenChange(false);
    onReportUpdated?.();
  });
            ...
            <div className="pt-4 border-t border-gray-200">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Button
                  ...
                  variant="destructive"
                  className="min-h-[48px] bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 font-medium touch-manipulation"
                >
                ...
                <Button
                  ...
                  disabled={isProcessing}
                  variant="destructive"
                  className="min-h-[48px] bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 font-medium touch-manipulation"
                >
                  <UserX className="w-4 h-4 mr-2" />
