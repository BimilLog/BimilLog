            ...
            <div className="card mb-4">
              <div className="card-body p-4">
                ...
                <section className="mb-4">
                  ...
                  <ol className="ms-4">
                    <li className="mb-2">
                      "서비스"란 사용자가 로그인 없이 메시지를 남기고, 수신자가
                      로그인하여 메시지를 확인하는 웹 기반의 익명 메시지 전달
                      시스템을 의미합니다.
                    </li>
                    <li className="mb-2">
                      "이용자"란 본 서비스를 이용하는 모든 주체로, 메시지를
                      남기는 사람과 수신자를 포함합니다.
                    </li>
                    <li className="mb-2">
                ...
                <section className="mb-4">
                  <h2 className="mb-3">제3조 (이용 조건)</h2>
                  <ol className="ms-4">
                    <li className="mb-2">
                ...
                <section className="mb-4">
                  <h2 className="mb-3">제4조 (메시지 저장 및 관리)</h2>
                  <ol className="ms-4">
                    <li className="mb-2">
                      이용자가 남긴 메시지는{" "}
                      전송 시점에 서버(DB)에 저장됩니다.
                    </li>
                    <li className="mb-2">
                      메시지는{" "}
                      수신자가 직접 삭제하는 경우에만 삭제되며,
                      별도의 자동 삭제 기능은 제공하지 않습니다.
                    </li>
                  </ol>
                </section>
                ...
                <section className="mb-4">
                  <h2 className="mb-3">제5조 (서비스 이용 제한)</h2>
                  <p>
                    회사는 아래에 해당하는 경우, 이용자의 서비스 이용을 제한할
                    수 있습니다.
                  </p>
                  <ul className="ms-4">
                    <li className="mb-2">
                ...
                <section className="mb-4">
                  <h2 className="mb-3">제6조 (지적재산권)</h2>
                  <p>
                ...
                <section className="mb-4">
                  <h2 className="mb-3">제8조 (약관의 변경)</h2>
                  <p>
