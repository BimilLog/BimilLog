          ...
          <div className="col-lg-12">
            <div className="card mb-4">
              <div className="card-body p-4">
                <h1 className="mb-4 text-center">개인정보 처리방침</h1>

                <section className="mb-4">
                  <h2 className="mb-3">[1. 총 칙]</h2>
                  <p>
                    '농장 키우기'(이하 "회사"라 합니다)는 이용자가 회사의
                    서비스를 이용함과 동시에 온라인상에서 회사에 제공한
                    개인정보가 보호 받을 수 있도록 최선을 다하고 있습니다. 이에
                    회사는 정보통신망 이용촉진 및 정보보호 등에 관한 법률 등
                    정보통신서비스 제공자가 준수하여야 할 관련 법규상의
                    개인정보보호 규정 및 지침을 준수하고 있습니다. 회사는
                    개인정보 처리방침을 통하여 이용자들이 제공하는 개인정보가
                    어떠한 용도와 방식으로 이용되고 있으며 개인정보 보호를 위해
                    어떠한 조치가 취해지고 있는지 알려 드립니다. 회사는 개인정보
                    처리방침을 홈페이지 첫 화면에 공개함으로써 이용자들이 언제나
                    용이하게 보실수 있도록 조치하고 있습니다. 회사의 개인정보
                    처리방침은 정부의 법률 및 지침 변경이나 회사의 내부 방침
                    변경 등으로 인하여 수시로 변경될 수 있으므로 이용자들께서는
                    사이트 첫페이지에 고지되는 개인정보처리방침을 사이트 방문 시
                    수시로 확인하시기 바랍니다. 회사의 개인정보 처리방침은
                    다음과 같은 내용을 담고 있습니다.
                  </p>
                </section>

                <section className="mb-4">
                  <h2 className="mb-3">[2. 개인정보 수집에 대한 동의]</h2>
                  <p>
                    회사는 이용자들이 회사의 개인정보 처리방침 또는 이용약관의
                    내용에 대해 "동의"버튼 또는 "취소"버튼을 클릭할 수 있는
                ...
                <section className="mb-4">
                  <h2 className="mb-3">[3. 개인정보의 수집 및 이용목적]</h2>
                  <p>
                    "개인정보"라 함은 생존하는 개인에 관한 정보로서 당해 정보에
                    포함되어 있는 카카오톡 닉네임, 카카오톡 프로필사진 등의 사항에 의하여 당해 개인을
                ...
                <section className="mb-4">
                  <h2 className="mb-3">[4. 수집하는 개인정보의 수집방법]</h2>
                  <p>
                    ① 회사는 이용자들이 회원서비스를 이용하기 위해 회원으로
                    가입하실 때 서비스 제공을 위한 필수적인 정보들을
                    온라인상에서 입력 받고 있습니다. 회원 가입 시에 받는
                    필수적인 정보는 카카오ID(식별자), 카카오톡 닉네임, 카카오톡 프로필사진 등입니다. 또한 양질의
                    서비스 제공을 위하여 이용자들이 선택적으로 입력할 수 있는
                    사항으로서 전화번호 등을 입력 받고 있습니다. 또한 쇼핑몰
                    내에서의 설문조사나 이벤트 행사 시 통계분석이나 경품제공
                ...
                <section className="mb-4">
                  <h2 className="mb-3">[5. 개인정보의 보유 및 이용기간]</h2>
                  <p>
                  ...
                  <p>
                    ...
                    경우를 방지하기 위하여 탈퇴한 이용자의 "최소한의 개인정보"를
                ...
                <section className="mb-4">
                  <h2 className="mb-3">[6. 개인정보 파기절차 및 방법]</h2>
                  <p>
                ...
                <section className="mb-4">
                  <h2 className="mb-3">[7. 수집한 개인정보의 공유 및 제공]</h2>
                  <p>
                  ...
                  <ul className="ms-4">
                    <li>
                      ...
                      한국은행법, 형사소송법등 법령에 특별한 규정이 있는 경우
                    </li>
                    <li>
                ...
                <section className="mb-4">
                  ...
                  <p>
                    ...
                    제3자에게 제공한 동의의 철회는 카카오를 통해 연결 끊기를 요청하여 가능합니다.
                  </p>
                </section>
                ...
                <section className="mb-4">
                  ...
                  <p>
                    ...
                    웹브라우저에서 [도구]-[인터넷 옵션]-[보안]-[사용자 정의
                    수준]을 선택함으로써 모든 쿠키를 허용하거나, 쿠키가 저장될
                    때 마다 확인을 거치거나, 아니면 모든 쿠키의 저장을 거부할 수
                    있습니다. 단, 모든 쿠키의 저장을 거부하는 경우, 쿠키를 통해
                ...
                <section className="mb-4">
                  <h2 className="mb-3">[11. 아동의 개인정보 보호]</h2>
                  <p>
                ...
                <section className="mb-4">
                  <h2 className="mb-3">[12. 이용자의 권리와 의무]</h2>
                  <p>
                    ① 이용자의 개인정보를 최신의 상태로 정확하게 입력하여 불의의
                    사고를 예방해주시기 바랍니다. 이용자가 입력한 부정확한
                    정보로 인해 발생하는 사고의 책임은 이용자 자신에게 있으며
                    타인 정보의 도용 등 허위정보를 입력할 경우 계정의 이용이
                    제한될 수 있습니다.
                  </p>
                  <p>
                    ② 이용자는 개인정보를 보호받을 권리를 보유하나 이와 동시에
                    본인의 정보를 스스로 보호하고 또한 타인의 정보를 침해하지
                    않을 의무도 가지고 있습니다. 비밀번호를 포함한 이용자의
                ...
                <section className="mb-4">
                  <h2 className="mb-3">[13. 의견수렴 및 불만처리]</h2>
                  <p>
                    ① 회사는 귀하의 의견을 소중하게 생각하며, 귀하는
                    의문사항으로부터 언제나 성실한 답변을 받을 권리가 있으며,
                    귀하와의 원활환 의사소통을 위해 고객센터를 운영하고
                ...
                <section className="mb-4">
                  <h2 className="mb-3">[14. 개인정보보호 책임자 및 담당자]</h2>
                  <p>
