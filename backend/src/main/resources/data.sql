...
VALUES
    ...
    (6, 6, 6, 0), (7, 7, 7, 0), (8, 8, 8, 0), (9, 9, 9, 0), (10, 10, 10, 0),
    (11, 11, 11, 0), (12, 12, 12, 0), (13, 13, 13, 0), (14, 14, 14, 0), (15, 15, 15, 0),
    (16, 16, 16, 0), (17, 17, 17, 0), (18, 18, 18, 0), (19, 19, 19, 0), (20, 20, 20, 0),
    (21, 21, 21, 0), (22, 22, 22, 0),

    -- 게시글 1번 내 댓글 계층 (댓글 1,2,3)
    -- 1번 댓글에 2번 댓글이 답글
    (23, 1, 2, 1),

    -- 게시글 2번 내 댓글 계층 (댓글 4,5,6,7)
    -- 4번 댓글에 5번 댓글이 답글
    (24, 4, 5, 1),
...
-- comment_closure_seq 시퀀스 초기화
INSERT INTO comment_closure_seq (next_val) VALUES (30);
