...
VALUES 
    (2, 11), (2, 15), (2, 17), (2, 19),  -- 사용자1이 추천한 글들
    (3, 1), (3, 5), (3, 21), (3, 25),   -- 사용자2가 추천한 글들
    (4, 2), (4, 12), (4, 16), (4, 20),  -- 사용자3이 추천한 글들
    (2, 22), (3, 3), (4, 13);           -- 추가 추천들
...
-- 롤링페이퍼 메시지 데이터
INSERT INTO message (height, width, anonymity, created_at, message_id, modified_at, user_id, content, deco_type)
VALUES
    (0, 0, '농부', DATE_SUB(NOW(6), INTERVAL 3 DAY), 1, DATE_SUB(NOW(6), INTERVAL 3 DAY), 1,
     '안녕하세요! 비밀로그 정말 재미있어요. 앞으로도 좋은 서비스 부탁드려요!', 'STRAWBERRY'),
    (0, 1, '당근', DATE_SUB(NOW(6), INTERVAL 2 DAY), 2, DATE_SUB(NOW(6), INTERVAL 2 DAY), 1,
     '버그 신고 글 잘 봤어요. 덕분에 문제가 해결될 것 같아요. 감사합니다!', 'CARROT'),
    (0, 2, '커피', DATE_SUB(NOW(6), INTERVAL 1 DAY), 3, DATE_SUB(NOW(6), INTERVAL 1 DAY), 1,
     '항상 열심히 활동해주셔서 감사해요. 좋은 하루 되세요!', 'COFFEE'),
    (1, 0, '고양이', DATE_SUB(NOW(6), INTERVAL 12 HOUR), 4, DATE_SUB(NOW(6), INTERVAL 12 HOUR), 1,
     '비밀농부1님의 글들 항상 유익해요. 계속 좋은 글 부탁드려요!', 'CAT'),
    (1, 1, '별빛', DATE_SUB(NOW(6), INTERVAL 6 HOUR), 5, DATE_SUB(NOW(6), INTERVAL 6 HOUR), 1,
     '오늘도 좋은 하루 보내세요! 화이팅!', 'STAR'),

    (0, 3, '사과', DATE_SUB(NOW(6), INTERVAL 4 DAY), 6, DATE_SUB(NOW(6), INTERVAL 4 DAY), 2,
     '익명작가님의 개선 제안들 정말 좋아요! 모두 구현되면 좋겠어요.', 'APPLE'),
    (0, 4, '멍멍', DATE_SUB(NOW(6), INTERVAL 3 DAY), 7, DATE_SUB(NOW(6), INTERVAL 3 DAY), 2,
     '다크모드 제안 너무 좋아요. 빨리 생겼으면 좋겠어요!', 'DOG'),
    (0, 5, '달빛', DATE_SUB(NOW(6), INTERVAL 2 DAY), 8, DATE_SUB(NOW(6), INTERVAL 2 DAY), 2,
     '창의적인 아이디어 항상 감탄하고 있어요. 대단해요!', 'MOON'),
    (1, 3, '풍선', DATE_SUB(NOW(6), INTERVAL 1 DAY), 9, DATE_SUB(NOW(6), INTERVAL 1 DAY), 2,
     '태그 기능 제안 정말 좋았어요. 구현되길 바라요!', 'BALLOON'),
    (1, 4, '해바라', DATE_SUB(NOW(6), INTERVAL 8 HOUR), 10, DATE_SUB(NOW(6), INTERVAL 8 HOUR), 2,
     '항상 유용한 제안 감사해요. 좋은 하루 되세요!', 'SUNFLOWER'),

    (2, 0, '용용', DATE_SUB(NOW(6), INTERVAL 5 DAY), 11, DATE_SUB(NOW(6), INTERVAL 5 DAY), 3,
     '관리자님 항상 수고 많으세요! 덕분에 깨끗한 커뮤니티가 유지되는 것 같아요.', 'DRAGON'),
    (2, 1, '천사', DATE_SUB(NOW(6), INTERVAL 4 DAY), 12, DATE_SUB(NOW(6), INTERVAL 4 DAY), 3,
     '신고 처리 빨라서 감사해요. 앞으로도 잘 부탁드려요!', 'ANGEL'),
    (2, 2, '불새', DATE_SUB(NOW(6), INTERVAL 3 DAY), 13, DATE_SUB(NOW(6), INTERVAL 3 DAY), 3,
     '롤링메신저님 덕분에 안전한 소통이 가능해요. 감사합니다!', 'PHOENIX'),
    (2, 3, '왕관', DATE_SUB(NOW(6), INTERVAL 2 DAY), 14, DATE_SUB(NOW(6), INTERVAL 2 DAY), 3,
     '관리 업무 정말 고생 많으세요. 항상 응원합니다!', 'STAR'),
    (2, 4, '무지개', DATE_SUB(NOW(6), INTERVAL 1 DAY), 15, DATE_SUB(NOW(6), INTERVAL 1 DAY), 3,
     '공정한 관리 감사해요. 좋은 하루 되세요!', 'RAINBOW');
