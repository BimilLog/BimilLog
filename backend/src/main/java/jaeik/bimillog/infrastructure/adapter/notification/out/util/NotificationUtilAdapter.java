package jaeik.bimillog.infrastructure.adapter.notification.out.util;
 ...
 * <h2>알림 유틸리티 어댑터</h2>
 * <p>
 * 알림 전송 자격 확인과 FCM 토큰 조회를 담당하는 아웃바운드 어댑터입니다.
 * NotificationUtilPort를 구현하여 사용자 설정과 알림 타입에 따른 필터링을 제공합니다.
 * </p>
 * <p>사용자의 알림 설정을 기반으로 불필요한 알림 전송을 방지하고 성능을 최적화합니다.</p>
 *
 * @author Jaeik
 * @version 2.0.0
 */
