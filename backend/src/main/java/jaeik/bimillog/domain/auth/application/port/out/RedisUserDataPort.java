 ...
 * <p>
 * 소셜 로그인 후 신규 사용자의 임시 데이터를 Redis에 저장하고 관리하기 위한 포트입니다.
 * </p>
 * <p>회원가입 플로우에서 소셜 로그인과 닉네임 입력 사이의 임시 데이터 보관에 사용됩니다.</p>
 *
 * @author Jaeik
 * @version 2.0.0
 */
public interface RedisUserDataPort {
     ...
     * <p>SocialService에서 신규 사용자 소셜 로그인 처리 시 호출됩니다.</p>
     *
     ...
     * <p>SignUpService에서 회원가입 요청 처리 시 임시 데이터 복원을 위해 호출됩니다.</p>
     *
     ...
     * <p>SignUpService에서 회원가입 완료 처리 후 임시 데이터 정리를 위해 호출됩니다.</p>
     *
     ...
     * <p>SocialService에서 신규 사용자 소셜 로그인 완료 시 호출됩니다.</p>
     *
