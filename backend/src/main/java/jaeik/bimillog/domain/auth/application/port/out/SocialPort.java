...
/**
 * <h2>소셜 포트</h2>
 * <p>소셜 플랫폼과의 외부 연동 작업을 처리하는 포트입니다.</p>
 * <p>소셜 로그인, 로그아웃, 연결 해제 등 외부 소셜 API 호출</p>
 *
 * @author Jaeik
 * @version 2.0.0
 */
public interface SocialPort {
     ...
     * <p>{@link SocialService}에서 소셜 로그인 요청 처리 시 호출됩니다.</p>
     *
     ...
     * <p>{@link SocialService}에서 소셜 계정 연결 해제 요청 시 호출됩니다.</p>
     *
     ...
     * <p>{@link LogoutService}에서 사용자 로그아웃 요청 처리 시 호출됩니다.</p>
     *
