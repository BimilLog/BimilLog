...
/**
 * <h2>토큰 조회 포트</h2>
 * <p>Auth 도메인에서 Token 도메인의 토큰 정보를 조회하는 포트입니다.</p>
 * <p>사용자 토큰 조회, 블랙리스트 등록용 토큰 수집</p>
 *
 * @author Jaeik
 * @version 2.0.0
 */
public interface AuthToTokenPort {
     ...
     * <p>{@link LogoutService}에서 토큰 검증 또는 사용자 로그아웃 처리 시 호출됩니다.</p>
     *
     ...
     * <p>{@link UserBanService}에서 사용자의 모든 토큰을 블랙리스트 등록 처리 시 호출됩니다.</p>
     *
