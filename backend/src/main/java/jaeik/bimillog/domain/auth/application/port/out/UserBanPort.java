 ...
 * <p>
 * 사용자 차단과 토큰 블랙리스트 관리를 위한 Redis 캐시 처리와 사용자 존재성 확인을 담당하는 포트입니다.
 * </p>
 * <p>JWT 토큰 무효화, 블랙리스트 관리, 사용자 제재 관련 외부 시스템 연동을 처리합니다.</p>
 *
 * @author Jaeik
 * @version 2.0.0
 */
public interface UserBanPort {
     ...
     * <p>UserBanService에서 JWT 토큰 유효성 검증 시 호출됩니다.</p>
     *
     ...
     * <p>UserBanService에서 사용자 모든 토큰 블랙리스트 등록 처리 시 호출됩니다.</p>
     *
     ...
     * <p>UserBanService에서 토큰 블랙리스트 등록이나 검증 시 호출됩니다.</p>
     *
     ...
     * <p>SocialService에서 소셜 계정 연결 해제 요청 처리 시 사용자 존재성 확인을 위해 호출됩니다.</p>
     *
