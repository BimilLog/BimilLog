...
/**
 * <h2>방문 메시지 상세 정보 값 객체</h2>
 * <p>
 * 다른 사용자 롤링페이퍼 방문시 메시지 조회 결과를 담는 도메인 순수 값 객체
 * </p>
 * <p>PaperQueryService에서 롤링페이퍼 방문 시 반환 데이터 구조를 제공</p>
 * <p>방문자에게는 민감한 정보(익명 이름, 내용, 작성일시 등)를 노출하지 않음</p>
...
public record VisitMessageDetail(
     ...
     * <p>PaperQueryService에서 롤링페이퍼 방문 시 Message 엔티티 변환을 위해 호출되는 메서드</p>
     *
