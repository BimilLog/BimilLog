...
public interface CommentCommandUseCase {
     ...
     * @since 2.0.0
     */
    void updateComment(CommentRequest commentRequest, CustomUserDetails userDetails);
     ...
     * @since 2.0.0
     */
    void deleteComment(CommentRequest commentRequest, CustomUserDetails userDetails);
