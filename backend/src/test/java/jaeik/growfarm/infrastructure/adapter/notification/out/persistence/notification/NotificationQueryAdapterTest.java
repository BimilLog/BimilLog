...
class NotificationQueryAdapterTest {
    ...
    void shouldReturnNotificationList_WhenUserHasNotifications() {
        ...
        // When: 알림 목록 조회
        List<NotificationDTO> result = notificationQueryAdapter.getNotificationList(testUserDetails);
        ...
        NotificationDTO secondNotification = result.get(1);
        ...
        NotificationDTO thirdNotification = result.get(2);
    ...
    void shouldReturnAllNotificationTypes_WhenDifferentTypesExist() {
        ...
        // 각 유형별로 존재 확인
        assertThat(result)
                .extracting(NotificationDTO::getNotificationType)
    ...
    void shouldNotReturnOtherUsersNotifications_WhenQueryingNotifications() {
        ...
        assertThat(result)
                .extracting(NotificationDTO::getContent)
    ...
    @Transactional(readOnly = true)
    void shouldHandleLargeNotificationData_WhenManyNotificationsExist() {
        ...
        assertThat(result.get(0).getContent()).isEqualTo("알림 #100");
