...
public class PaperControllerIntegrationTest {
        ...
        void testVisitPaper() {
                // When
                ResponseEntity<List<VisitMessageDTO>> response = paperController
                                .visitPaper("testUser" + random.nextInt(1000000));
        ...
        void testPlantCrop() {
                ...
                // When
                ResponseEntity<String> response = paperController.plantCrop("testUser" + random.nextInt(1000000),
                                messageDTO);
