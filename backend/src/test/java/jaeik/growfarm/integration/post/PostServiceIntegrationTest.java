...
public class PostServiceIntegrationTest {
    ...
    void testRedisPopularPostsIntegration() {
        ...
        // When - 캐시 저장
        redisPostService.cachePopularPosts(RedisPostService.PopularPostType.REALTIME, mockPosts);

        // Then - 캐시 조회
        List<SimplePostDTO> cachedPosts = redisPostService.getCachedPopularPosts(RedisPostService.PopularPostType.REALTIME);
        ...
        // 캐시가 삭제되었는지 확인
        boolean hasCache = redisPostService.hasPopularPostsCache(RedisPostService.PopularPostType.REALTIME);
