//package jaeik.growfarm.unit.controller.user;
//
...
//        SimplePostResDTO simplePostResDTO = SimplePostResDTO.builder()
//                .postId(1L)
//                .userId(1L)
//                .userName("testPaper")
//                .title("Test Title")
...
//                .build();
//
//        List<SimplePostResDTO> simplePostResDTOList = new ArrayList<>();
//        simplePostResDTOList.add(simplePostResDTO);
//
//        Page<SimplePostResDTO> postPage = new PageImpl<>(simplePostResDTOList);
