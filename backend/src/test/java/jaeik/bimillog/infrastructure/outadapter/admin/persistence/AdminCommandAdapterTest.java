package jaeik.bimillog.infrastructure.outadapter.admin.persistence;

import jaeik.bimillog.domain.admin.entity.Report;
import jaeik.bimillog.domain.admin.entity.ReportType;
import jaeik.bimillog.domain.auth.entity.SocialProvider;
import jaeik.bimillog.domain.user.entity.User;
import jaeik.bimillog.infrastructure.adapter.admin.out.persistence.AdminCommandAdapter;
import jaeik.bimillog.infrastructure.adapter.admin.out.persistence.ReportRepository;
