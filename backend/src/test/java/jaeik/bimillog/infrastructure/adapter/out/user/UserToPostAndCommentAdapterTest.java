...
/**
 * <h2>UserToPostAndCommentAdapter 테스트</h2>
...
class UserToPostAndCommentAdapterTest {
    ...
    @InjectMocks
    private UserToPostAndCommentAdapter userToPostAndCommentAdapter;
    ...
    void shouldFindPostsByUserId_WhenValidUserIdProvided() {
        ...
        // When
        Page<PostSearchResult> result = userToPostAndCommentAdapter.findPostsByUserId(TEST_USER_ID, TEST_PAGEABLE);
    ...
    void shouldFindLikedPostsByUserId_WhenValidUserIdProvided() {
        ...
        // When
        Page<PostSearchResult> result = userToPostAndCommentAdapter.findLikedPostsByUserId(TEST_USER_ID, TEST_PAGEABLE);
    ...
    void shouldFindCommentsByUserId_WhenValidUserIdProvided() {
        ...
        // When
        Page<SimpleCommentInfo> result = userToPostAndCommentAdapter.findCommentsByUserId(TEST_USER_ID, TEST_PAGEABLE);
    ...
    void shouldFindLikedCommentsByUserId_WhenValidUserIdProvided() {
        ...
        // When
        Page<SimpleCommentInfo> result = userToPostAndCommentAdapter.findLikedCommentsByUserId(TEST_USER_ID, TEST_PAGEABLE);
