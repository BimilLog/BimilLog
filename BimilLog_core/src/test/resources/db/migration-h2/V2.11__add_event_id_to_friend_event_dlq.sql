...
-- 1. 기존 유니크 인덱스 삭제
DROP INDEX IF EXISTS uk_dlq_pending_event;

-- 2. event_id 컬럼 추가 (임시로 nullable)
ALTER TABLE friend_event_dlq ADD COLUMN IF NOT EXISTS event_id VARCHAR(255) NULL;
...
ALTER TABLE friend_event_dlq ALTER COLUMN event_id SET NOT NULL;
