...
public class KakaoTestDataBuilder {
     ...
     */
    public static KakaoFriendsDTO.KakaoFriend createKakaoFriend(Long id, String uuid,
                                                                String nickname, String image,
                                                                Boolean favorite) {
        try {
            KakaoFriendsDTO.KakaoFriend kakaoFriend = new KakaoFriendsDTO.KakaoFriend();
            TestFixtures.setFieldValue(kakaoFriend, "id", id);
            TestFixtures.setFieldValue(kakaoFriend, "uuid", uuid);
            TestFixtures.setFieldValue(kakaoFriend, "profileNickname", nickname);
            TestFixtures.setFieldValue(kakaoFriend, "profileThumbnailImage", image);
            TestFixtures.setFieldValue(kakaoFriend, "favorite", favorite);
            return kakaoFriend;
        } catch (Exception e) {
     ...
     */
    public static KakaoFriendsDTO createKakaoFriendsResponse(List<KakaoFriendsDTO.KakaoFriend> elements,
                                                            Integer totalCount,
                                                            String beforeUrl, 
                                                            String afterUrl,
