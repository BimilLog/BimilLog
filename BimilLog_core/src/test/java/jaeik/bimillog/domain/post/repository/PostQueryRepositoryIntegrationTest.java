...
@Import({PostSearchRepository.class, PostQueryRepository.class, QueryDSLConfig.class, LocalIntegrationTestSupportConfig.class})
...
class PostQueryRepositoryIntegrationTest {
    ...
    void shouldFindPostsByMemberId_WhenValidMemberIdProvided() {
        ...
        // When: 사용자별 게시글 조회
        Page<PostSimpleDetail> result = postQueryRepository.findPosts(
                PostQueryType.MEMBER_POSTS,
