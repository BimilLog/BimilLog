...
public class MemberBlackController {
    ...
    public ResponseEntity<Page<String>> getBlacklist(@AuthenticationPrincipal CustomUserDetails userDetails, Pageable pageable) {
        Page<String> myBlacklist = memberBlacklistService.getMyBlacklist(userDetails.getMemberId(), pageable);
