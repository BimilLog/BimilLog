...
public class FriendshipCommandService {
    ...
    private final FriendshipRedisUpdateSync friendshipRedisUpdateSync;
    ...
    public void createFriendship(Long memberId, Long friendId, Long friendRequestId) {
        ...
        // 비동기 Redis 친구 관계 추가
        friendshipRedisUpdateSync.addFriendToRedis(memberId, friendId);
    }
    ...
    public void deleteFriendship(Long memberId, Long friendshipId) {
        ...
        // 비동기 Redis 친구 관계 삭제
        friendshipRedisUpdateSync.deleteFriendToRedis(memberId1, memberId2);
    }
