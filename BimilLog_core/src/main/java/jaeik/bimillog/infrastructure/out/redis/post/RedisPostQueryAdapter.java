package jaeik.bimillog.infrastructure.out.redis.post;
...
import jaeik.bimillog.infrastructure.out.redis.post.RedisPostKeys.CacheMetadata;
...
import static jaeik.bimillog.infrastructure.out.redis.post.RedisPostKeys.*;
